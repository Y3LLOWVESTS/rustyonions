<!-- Generated by scripts/make_crate_codex.sh on 2025-12-18T19:02:32Z -->
...
// RO:WHY  — Fast operator navigation; dev-only Playground link is gated by ui-config.
// RO:INVARIANTS —
//   - Playground link must be hidden unless enableAppPlayground=true.
//   - If ui-config fetch fails, keep Playground hidden (safe posture).
    ...
    <aside className="svc-admin-sidebar">
      ...
      <nav>
        <ul>
          ...
          {playgroundEnabled && (
            <li>
              <NavLink to="/playground" className={linkClassName}>
                Playground
              </NavLink>
            </li>
          )}
