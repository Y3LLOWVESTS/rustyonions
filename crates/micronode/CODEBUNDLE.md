<!-- Generated by scripts/make_crate_codex.sh on 2026-07-15T04:33:04Z -->
...
- [crates/micronode/dev_facets/hello_app.toml](#crates-micronode-devfacets-helloapp-toml)
- [crates/micronode/dev_facets/hello_proxy.toml](#crates-micronode-devfacets-helloproxy-toml)
- [crates/micronode/dev_facets/wow_site.toml](#crates-micronode-devfacets-wowsite-toml)
...
- [crates/micronode/src/challenge_outbox.rs](#crates-micronode-src-challengeoutbox-rs)
...
- [crates/micronode/src/economic_audit.rs](#crates-micronode-src-economicaudit-rs)
...
- [crates/micronode/src/http/admin_api.rs](#crates-micronode-src-http-adminapi-rs)
...
- [crates/micronode/src/http/verification.rs](#crates-micronode-src-http-verification-rs)
...
- [crates/micronode/src/verification.rs](#crates-micronode-src-verification-rs)
...
- [crates/micronode/tests/internal_roc_beta_phase17_epoch_replay.rs](#crates-micronode-tests-internalrocbetaphase17epochreplay-rs)
...
- [crates/micronode/tests/object_verification.rs](#crates-micronode-tests-objectverification-rs)
- [crates/micronode/tests/passive_runtime.rs](#crates-micronode-tests-passiveruntime-rs)
...
# HTTP client (needed for FacetKind::Proxy at runtime)
...
### crates/micronode/dev_facets/hello_app.toml
<a id="crates-micronode-devfacets-helloapp-toml"></a>

```toml
# crates/micronode/dev_facets/hello_app.toml
#
# Proxy facet for the hello-app workload (external process).
# Artifact-adjacent config: NOT embedded in binaries (no demo lock-in).
#
# Mounts under:
#   /facets/hello/...
#
...
host = "127.0.0.1"
port = 5401
# Optional base path on the upstream. Keep "" when the app serves at "/".
base_path = ""

# --- Explicit routes (operator clarity in /facets/_meta) ---
...
# --- Wildcard fallback (BYO endpoints; keeps DX “just works”) ---
# Proxies anything under /facets/hello/* to the upstream.
[[route]]
method = "GET"
path = "/*tail"
...
### crates/micronode/dev_facets/hello_proxy.toml
<a id="crates-micronode-devfacets-helloproxy-toml"></a>

```toml
# crates/micronode/dev_facets/hello_proxy.toml
#
# LEGACY / REFERENCE manifest.
# This exists only as an explicit-route example. It is NOT used by the WOW demo.
# (We keep it non-conflicting by using a different facet id.)
...
### crates/micronode/dev_facets/wow_site.toml
<a id="crates-micronode-devfacets-wowsite-toml"></a>

```toml
# wow_site.toml — WOW demo facet (static site)
#
# Served at:
#   http://127.0.0.1:5310/facets/wow/
#
# NOTE:
# - This uses per-route file mappings (simple + explicit).
# - Keeps UX clean: no content IDs/hashes exposed.

id = "wow"
kind = "static"

routes = [
  { path = "/",         file = "examples/site-demo/site/index.html" },
  { path = "/index.html", file = "examples/site-demo/site/index.html" },
  { path = "/app.js",   file = "examples/site-demo/site/app.js" },
  { path = "/style.css", file = "examples/site-demo/site/style.css" }
]
...
<a id="crates-micronode-src-challengeoutbox-rs"></a>
...
<a id="crates-micronode-src-economicaudit-rs"></a>
...
<a id="crates-micronode-src-http-adminapi-rs"></a>
...
### crates/micronode/src/http/verification.rs
<a id="crates-micronode-src-http-verification-rs"></a>
...
impl AppState {
    pub fn new(cfg: Config) -> Self {
        ...
        Self { cfg, metrics, health, probes, storage, verification, started_at }
    }
...
### crates/micronode/src/verification.rs
<a id="crates-micronode-src-verification-rs"></a>
...
<a id="crates-micronode-tests-internalrocbetaphase17epochreplay-rs"></a>
...
### crates/micronode/tests/object_verification.rs
<a id="crates-micronode-tests-objectverification-rs"></a>
...
<a id="crates-micronode-tests-passiveruntime-rs"></a>
