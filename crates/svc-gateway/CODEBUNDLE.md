<!-- Generated by scripts/make_crate_codex.sh on 2026-08-23T03:16:09Z -->
...
- [crates/svc-gateway/scripts/dev-internal-roc-beta-phase2-preflight.sh](#crates-svc-gateway-scripts-dev-internal-roc-beta-phase2-preflight-sh)
- [crates/svc-gateway/scripts/dev-internal-roc-beta-phase4-preflight.sh](#crates-svc-gateway-scripts-dev-internal-roc-beta-phase4-preflight-sh)
- [crates/svc-gateway/scripts/dev-internal-roc-stabilization-paid-route-preflight.sh](#crates-svc-gateway-scripts-dev-internal-roc-stabilization-paid-route-preflight-sh)
...
- [crates/svc-gateway/tests/cn2_canonical_defaults.rs](#crates-svc-gateway-tests-cn2canonicaldefaults-rs)
- [crates/svc-gateway/tests/content_view_routes_proxy.rs](#crates-svc-gateway-tests-contentviewroutesproxy-rs)
- [crates/svc-gateway/tests/final_beta_phase10_explore_discovery_proxy.rs](#crates-svc-gateway-tests-finalbetaphase10explorediscoveryproxy-rs)
- [crates/svc-gateway/tests/final_beta_phase14_publication_relation_gateway.rs](#crates-svc-gateway-tests-finalbetaphase14publicationrelationgateway-rs)
- [crates/svc-gateway/tests/final_beta_phase15_site_publication_gateway.rs](#crates-svc-gateway-tests-finalbetaphase15sitepublicationgateway-rs)
- [crates/svc-gateway/tests/final_beta_phase6_creator_publication_gateway.rs](#crates-svc-gateway-tests-finalbetaphase6creatorpublicationgateway-rs)
...
- [crates/svc-gateway/tests/internal_roc_beta_paid_content_route_boundary.rs](#crates-svc-gateway-tests-internalrocbetapaidcontentrouteboundary-rs)
- [crates/svc-gateway/tests/internal_roc_beta_phase2_replay_visibility_boundary.rs](#crates-svc-gateway-tests-internalrocbetaphase2replayvisibilityboundary-rs)
- [crates/svc-gateway/tests/internal_roc_beta_phase4_confirmation_failure_boundary.rs](#crates-svc-gateway-tests-internalrocbetaphase4confirmationfailureboundary-rs)
- [crates/svc-gateway/tests/internal_roc_stabilization_paid_route_error_boundary.rs](#crates-svc-gateway-tests-internalrocstabilizationpaidrouteerrorboundary-rs)
...
- [crates/svc-gateway/tests/quickchain_phase3_validator_boundary.rs](#crates-svc-gateway-tests-quickchainphase3validatorboundary-rs)
- [crates/svc-gateway/tests/quickchain_phase3_validator_lifecycle_boundary.rs](#crates-svc-gateway-tests-quickchainphase3validatorlifecycleboundary-rs)
- [crates/svc-gateway/tests/quickchain_phase4_bond_boundary.rs](#crates-svc-gateway-tests-quickchainphase4bondboundary-rs)
- [crates/svc-gateway/tests/quickchain_phase4_bond_dispute_boundary.rs](#crates-svc-gateway-tests-quickchainphase4bonddisputeboundary-rs)
- [crates/svc-gateway/tests/quickchain_phase4_bond_enforcement_boundary.rs](#crates-svc-gateway-tests-quickchainphase4bondenforcementboundary-rs)
- [crates/svc-gateway/tests/quickchain_phase5_anchor_status_boundary.rs](#crates-svc-gateway-tests-quickchainphase5anchorstatusboundary-rs)
- [crates/svc-gateway/tests/quickchain_phase5_da_fallback_boundary.rs](#crates-svc-gateway-tests-quickchainphase5dafallbackboundary-rs)
- [crates/svc-gateway/tests/quickchain_phase5_external_posture_boundary.rs](#crates-svc-gateway-tests-quickchainphase5externalpostureboundary-rs)
...
<a id="crates-svc-gateway-scripts-dev-internal-roc-beta-phase2-preflight-sh"></a>
...
### crates/svc-gateway/scripts/dev-internal-roc-beta-phase4-preflight.sh
<a id="crates-svc-gateway-scripts-dev-internal-roc-beta-phase4-preflight-sh"></a>
...
<a id="crates-svc-gateway-scripts-dev-internal-roc-stabilization-paid-route-preflight-sh"></a>
...
### crates/svc-gateway/tests/cn2_canonical_defaults.rs
<a id="crates-svc-gateway-tests-cn2canonicaldefaults-rs"></a>
...
### crates/svc-gateway/tests/final_beta_phase10_explore_discovery_proxy.rs
<a id="crates-svc-gateway-tests-finalbetaphase10explorediscoveryproxy-rs"></a>
...
fn parse_query(uri: &Uri) -> HashMap<String, String> {
    uri.query()
        .unwrap_or_default()
        .split('&')
        .filter(|pair| pair.is_empty() == false)
        .filter_map(|pair| {
...
### crates/svc-gateway/tests/final_beta_phase14_publication_relation_gateway.rs
<a id="crates-svc-gateway-tests-finalbetaphase14publicationrelationgateway-rs"></a>
...
### crates/svc-gateway/tests/final_beta_phase15_site_publication_gateway.rs
<a id="crates-svc-gateway-tests-finalbetaphase15sitepublicationgateway-rs"></a>
...
### crates/svc-gateway/tests/final_beta_phase6_creator_publication_gateway.rs
<a id="crates-svc-gateway-tests-finalbetaphase6creatorpublicationgateway-rs"></a>
...
fn phase6b4_gateway_route_surface_is_proxy_only() {
    ...
    for forbidden in [
        ...
        assert!(
            product_source.contains(forbidden,) == false,
...
fn phase6b4_gateway_does_not_bypass_omnigate_for_publications() {
    ...
    assert!(product_source.contains("/v1/index/creators/",) == false,);

    assert!(product_source.contains("svc_index",) == false,);

    assert!(product_source.contains("index_client",) == false,);
...
#[tokio::test]
async fn cn4_generic_gateway_challenge_and_prove_routes_remain_absent() {
    let _guard = ENV_LOCK.lock().await;
    clear_env();
    ...
    for public_path in ["/identity/passport/challenge", "/identity/passport/prove"] {
        let response = client
...
<a id="crates-svc-gateway-tests-internalrocbetapaidcontentrouteboundary-rs"></a>
...
<a id="crates-svc-gateway-tests-internalrocbetaphase2replayvisibilityboundary-rs"></a>
...
### crates/svc-gateway/tests/internal_roc_beta_phase4_confirmation_failure_boundary.rs
<a id="crates-svc-gateway-tests-internalrocbetaphase4confirmationfailureboundary-rs"></a>
...
<a id="crates-svc-gateway-tests-internalrocstabilizationpaidrouteerrorboundary-rs"></a>
...
<a id="crates-svc-gateway-tests-quickchainphase3validatorboundary-rs"></a>
...
<a id="crates-svc-gateway-tests-quickchainphase3validatorlifecycleboundary-rs"></a>
...
<a id="crates-svc-gateway-tests-quickchainphase4bondboundary-rs"></a>
...
<a id="crates-svc-gateway-tests-quickchainphase4bonddisputeboundary-rs"></a>
...
<a id="crates-svc-gateway-tests-quickchainphase4bondenforcementboundary-rs"></a>
...
<a id="crates-svc-gateway-tests-quickchainphase5anchorstatusboundary-rs"></a>
...
<a id="crates-svc-gateway-tests-quickchainphase5dafallbackboundary-rs"></a>
...
<a id="crates-svc-gateway-tests-quickchainphase5externalpostureboundary-rs"></a>
