<!-- Generated by scripts/make_crate_codex.sh on 2026-06-15T03:27:20Z -->
...
fn route_source_does_not_unlock_paid_content_from_cache_or_query_claims() {
    let route_root = Path::new("crates/svc-gateway/src/routes");
    let mut files = Vec::new();
    collect_rust_files(route_root, &mut files);
