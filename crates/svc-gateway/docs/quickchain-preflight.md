...
Focused test: quickchain_phase5_da_fallback_boundary
...
There is no external settlement, public bridge, ROX runtime, Solana runtime, staking, liquidity, exchange-facing logic, public market authority, or outside-program authority in svc-gateway.
