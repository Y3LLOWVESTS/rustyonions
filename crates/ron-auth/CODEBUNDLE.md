<!-- Generated by scripts/make_crate_codex.sh on 2026-08-20T05:32:49Z -->
...
//! RO:INTERACTS — canonical DeviceAuthorizationV1 transcript construction, strict future Ed25519 verification, and preserved Phase-0 svc-passport evidence.
...
//! RO:METRICS — none.
//! RO:CONFIG — none.
//! RO:SECURITY — constants only; no key loading, signing, persistence, HTTP, capability issuance, wallet mutation, or ledger mutation.
...
fn physical_m1_phase0_pipe_transcript_is_preserved_but_not_signable() {
    ...
    assert!(!DEVICE_AUTHORIZATION_V1_LEGACY_PHASE0_TRANSCRIPT_SIGNABLE,);

    assert!(!DEVICE_AUTHORIZATION_V1_JSON_TRANSCRIPT_SIGNABLE,);
