<!-- Generated by scripts/make_crate_codex.sh on 2026-06-25T00:53:21Z -->
...
fn storage_accounting_export_rejects_validator_lifecycle_authority_fields() {
    ...
    for field in PHASE3_ROUND2_LIFECYCLE_AUTHORITY_KEYS {
        let top_level = accounting_export_json_with_top_level(field);
        assert!(
        ...
        let nested = accounting_export_json_with_nested_event(field);
        assert!(
