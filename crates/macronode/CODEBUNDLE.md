<!-- Generated by scripts/make_crate_codex.sh on 2026-07-15T18:42:57Z -->
...
mod tests {
    ...
    fn setup_token_ttl_accepts_short_lived_values() {
        let mut cfg = Config::default();
        cfg.admin_setup_token_ttl = Duration::from_secs(1);
    ...
    fn setup_token_ttl_rejects_subsecond_values() {
        let mut cfg = Config::default();
        cfg.admin_setup_token_ttl = Duration::from_millis(500);
    ...
    fn setup_token_ttl_rejects_effectively_permanent_values() {
        let mut cfg = Config::default();
        cfg.admin_setup_token_ttl = Duration::from_secs(60 * 60 + 1);
