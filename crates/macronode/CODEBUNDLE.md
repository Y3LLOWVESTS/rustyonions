<!-- Generated by scripts/make_crate_codex.sh on 2025-11-20T00:15:58Z -->
...
//!   - Callers use `load_config()` or `load_config_with_file()`; no ad-hoc
...
pub use load::{load_config, load_config_with_file};
...
//!   - If bound to NON-loopback AND no token is set, we BLOCK unless MACRONODE_DEV_INSECURE=1.
