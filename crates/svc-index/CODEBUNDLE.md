<!-- Generated by scripts/make_crate_codex.sh on 2026-08-12T01:44:27Z -->
...
- [crates/svc-index/src/discovery.rs](#crates-svc-index-src-discovery-rs)
...
- [crates/svc-index/src/http/routes/creator_publications.rs](#crates-svc-index-src-http-routes-creatorpublications-rs)
- [crates/svc-index/src/http/routes/explore_discovery.rs](#crates-svc-index-src-http-routes-explorediscovery-rs)
...
- [crates/svc-index/src/publications.rs](#crates-svc-index-src-publications-rs)
- [crates/svc-index/src/relations.rs](#crates-svc-index-src-relations-rs)
...
- [crates/svc-index/tests/final_beta_phase10_explore_discovery_projection.rs](#crates-svc-index-tests-finalbetaphase10explorediscoveryprojection-rs)
- [crates/svc-index/tests/final_beta_phase14_imageboard_relations.rs](#crates-svc-index-tests-finalbetaphase14imageboardrelations-rs)
- [crates/svc-index/tests/final_beta_phase6_creator_publication_http.rs](#crates-svc-index-tests-finalbetaphase6creatorpublicationhttp-rs)
- [crates/svc-index/tests/final_beta_phase6_creator_publication_projection.rs](#crates-svc-index-tests-finalbetaphase6creatorpublicationprojection-rs)
...
inmem = []
otel = ["dep:opentelemetry", "dep:opentelemetry_sdk", "dep:tracing-opentelemetry", "dep:opentelemetry-otlp"]
facets = []
...
opentelemetry-otlp = { version = "0.17", optional = true, features = ["trace", "grpc-tonic"] }
http = "1"
headers = "0.4"
ulid = "1"
...
### crates/svc-index/src/discovery.rs
<a id="crates-svc-index-src-discovery-rs"></a>
...
### crates/svc-index/src/http/routes/creator_publications.rs
<a id="crates-svc-index-src-http-routes-creatorpublications-rs"></a>
...
### crates/svc-index/src/http/routes/explore_discovery.rs
<a id="crates-svc-index-src-http-routes-explorediscovery-rs"></a>
...
### crates/svc-index/src/publications.rs
<a id="crates-svc-index-src-publications-rs"></a>
...
### crates/svc-index/src/relations.rs
<a id="crates-svc-index-src-relations-rs"></a>

```rust
//! RO:WHAT — Strict bounded publication-relation projection for public parent/thread reads.
//! RO:WHY — FINAL_BETA Phase 14 needs durable Comment→parent/thread discovery without bloating PublicationSummaryV1 or creating an Imageboard-specific database.
//! RO:INTERACTS — PublicationSummaryV1, svc-index Store, relation keyspace, later Omnigate Comment publish and gateway public reads.
//! RO:INVARIANTS — source is a typed Comment publication; parent/site/thread references are canonical; private/unlisted relations never enter public projection.
...
impl PublicationRelationV1 {
    ...
    > {
        ...
        if self.publication.kind !=
            PublicationKind::Comment
        {
            return Err(
                invalid(
                    "publication.kind",
...
### crates/svc-index/tests/final_beta_phase10_explore_discovery_projection.rs
<a id="crates-svc-index-tests-finalbetaphase10explorediscoveryprojection-rs"></a>
...
### crates/svc-index/tests/final_beta_phase14_imageboard_relations.rs
<a id="crates-svc-index-tests-finalbetaphase14imageboardrelations-rs"></a>
...
### crates/svc-index/tests/final_beta_phase6_creator_publication_http.rs
<a id="crates-svc-index-tests-finalbetaphase6creatorpublicationhttp-rs"></a>
...
### crates/svc-index/tests/final_beta_phase6_creator_publication_projection.rs
<a id="crates-svc-index-tests-finalbetaphase6creatorpublicationprojection-rs"></a>
