<!-- Generated by scripts/make_crate_codex.sh on 2025-10-30T16:36:09Z -->
...
pub fn build_router() -> Router<Arc<AppState>> {
    let api = Router::new()
        ...
        .route("/resolve/:cid", get(routes::resolve::resolve))
        .route("/providers/:cid", get(routes::providers::providers))
        .route("/admin/seed", post(routes::admin::seed));
